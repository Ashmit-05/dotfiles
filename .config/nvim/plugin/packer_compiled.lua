...
_G.packer_plugins = {
  ...
  chadtree = {
    loaded = true,
    path = "/Users/ashmit/.local/share/nvim/site/pack/packer/start/chadtree",
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/Users/ashmit/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
  ...
  ["startup.nvim"] = {
    ...
    loaded = true,
    path = "/Users/ashmit/.local/share/nvim/site/pack/packer/start/startup.nvim",
